...
public class QAFOX_RegisterAccount_TestCase extends QAF_Common_Functions
{
	...
	public void check_registeraccountwith_validCredentials() throws Exception
	{
	    ...
	    Assert.assertTrue(QAFOX_RegisterAccount_Page.lastname_inputbox().isDisplayed(),"Respected inputbox should not be clicked ");
	    ...
	    Assert.assertTrue(QAFOX_RegisterAccount_Page.email_inputbox().isDisplayed(),"Respected inputbox should not be clicked ");
	    ...
	    Assert.assertTrue(QAFOX_RegisterAccount_Page.telephon_inputbox().isDisplayed(),"Respected inputbox should not be clicked");
	    ...
	    Assert.assertTrue(QAFOX_RegisterAccount_Page.password_inputbox().isDisplayed(),"Respected inputbox should not be clicked");
	    ...
	    Assert.assertTrue(QAFOX_RegisterAccount_Page.confirmPassword_inputbox().isDisplayed(),"Respected inputbox should not be clicked");
